                ...
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-10">
                        ...
                        <div class="home-product">
                            <div class="grid__row">
                                <!-- product item -->
                                <div class="grid__column-2-4" data-name="Đầm Hoa Xòe Tay Liền Dreamy" data-price="2290000" >
                                    <p class="home-product-item">
                                        <!-- Hình ảnh chính -->
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamHoaXoeTayLienDreamy2290.webp); height: 285px;">
                                        </div>
                                        ...
                                        <h4 class="home-product-item__name">Đầm Hoa Xòe Tay Liền Dreamy</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">2.290.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tensp" value="Đầm Hoa Xòe Tay Liền Dreamy" id="">
                                                    <input type="hidden" name="gia" value="2290000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamHoaXoeTayLienDreamy2290.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đâm Lụa Chấm Bi Lucile" data-price="1790000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamLuaChamBiLucille1790.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đâm Lụa Chấm Bi Lucile</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">1.790.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đâm Lụa Chấm Bi Lucile" id="">
                                                    <input type="hidden" name="gia" value="1790000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamLuaChamBiLucille1790.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm lụa đai nơ Dreamy" data-price="1590000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamLuaDaiNoDreamy1590.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm lụa đai nơ Dreamy</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đầm lụa đai nơ Dreamy" id="">
                                                    <input type="hidden" name="gia" value="1590000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamLuaDaiNoDreamy1590.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm Lụa Hoa Cổ V" data-price="1590000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamLuaHoaCoV1590.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm Lụa Hoa Cổ V</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đầm Lụa Hoa Cổ V" id="">
                                                    <input type="hidden" name="gia" value="1590000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamLuaHoaCoV1590.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm Lụa Phối Voan Dreamy" data-price="1690000" >
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamLuaPhoiVoanDreamy1690.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm Lụa Phối Voan Dreamy</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">1.323.000</span> -->
                                            <span class="home-product-item__price-current">1.690.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tensp" value="Đầm Lụa Phối Voan Dreamy" id="">
                                                    <input type="hidden" name="gia" value="1690000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamLuaPhoiVoanDreamy1690.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm Lụa Phối Voan Dreamy Trắng" data-price="1690000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamLuaPhoiVoanDreamyTrang1690.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm Lụa Phối Voan Dreamy Trắng</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đầm Lụa Phối Voan Dreamy Trắng" id="">
                                                    <input type="hidden" name="gia" value="1690000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamLuaPhoiVoanDreamyTrang1690.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm Xếp Ôm Luxury" data-price="1890000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamXepOmLuxury1890.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm Xếp Ôm Luxury</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">1.145.000</span> -->
                                            <span class="home-product-item__price-current">1.890.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đầm Xếp Ôm Luxury" id="">
                                                    <input type="hidden" name="gia" value="1890000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamXepOmLuxury1890.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm Xòe Bloom Cổ Đức" data-price="1590000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamXoeBloomCoDuc1590.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm Xòe Bloom Cổ Đức</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đầm Xòe Bloom Cổ Đức" id="">
                                                    <input type="hidden" name="gia" value="1590000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamXoeBloomCoDuc1590.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm Xòe Forall Lụa Midi" data-price="1890000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamXoeForalLuaMidi1890.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm Xòe Forall Lụa Midi</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đầm Xòe Forall Lụa Midi" id="">
                                                    <input type="hidden" name="gia" value="1890000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamXoeForalLuaMidi1890.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Đầm Xòe Rosalie" data-price="2390000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/vaydamnu/DamXoeRosalie2390.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Đầm Xòe Rosalie</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">995.000</span> -->
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Đầm Xòe Rosalie" id="">
                                                    <input type="hidden" name="gia" value="2390000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/vaydamnu/DamXoeRosalie2390.webp" id="">
                                                </form>
                                            </div>
                                        </div>
