                ...
                <div class="grid__row app__content">
                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                <li class="category-item category-item--active">
                                    <a href="quanjeans.php" class="category-item__link">Quần</a>
                                </li>
                                <li class="category-item">
                                    <a href="jumpsuit.php" class="category-item__link">Jumpsuit</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="grid__column-10">
                        ...
                        <div class="home-product">
                            <div class="grid__row">
                                <!-- product item -->
                                <div class="grid__column-2-4" data-name="Quần Dài Baggy Elena Tuysi" data-price="1287000" >
                                    <p class="home-product-item">
                                        <!-- Hình ảnh chính -->
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/QuandaiBaggyElenaTuysi1287.webp); height: 285px;">
                                        </div>
                                        ...
                                        <h4 class="home-product-item__name">Quần Dài Baggy Elena Tuysi</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">1.287.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tensp" value="Quần Dài Baggy Elena Tuysi" id="">
                                                    <input type="hidden" name="gia" value="1287000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/QuandaiBaggyElenaTuysi1287.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Jeans Loe Xẻ Gấu" data-price="545000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/Quanjeansloexegau545.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Jeans Loe Xẻ Gấu</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">545.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Jeans Loe Xẻ Gấu" id="">
                                                    <input type="hidden" name="gia" value="545000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/Quanjeansloexegau545.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Jeans Túi Vuông" data-price="2000000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/Quanjeanstuivuong2000.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Jeans Túi Vuông</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">1.024.000</span> -->
                                            <span class="home-product-item__price-current">2.000.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Jeans Túi Vuông" id="">
                                                    <input type="hidden" name="gia" value="2000000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/Quanjeanstuivuong2000.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Dài Tuysi Drape" data-price="900000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/QuandaiTuysiDrape900.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Dài Tuysi Drape</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Dài Tuysi Drape" id="">
                                                    <input type="hidden" name="gia" value="900000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/QuandaiTuysiDrape900.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Short Nora" data-price="525000" >
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/QuanShortsNora525.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Short Nora</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tensp" value="Quần Short Nora" id="">
                                                    <input type="hidden" name="gia" value="525000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/QuanShortsNora525.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Sooc Phối Phụ Kiện" data-price="850000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/Quansoocphoiphukien850.jpeg); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Sooc Phối Phụ Kiện</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">1.190.500</span> -->
                                            <span class="home-product-item__price-current">850.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Sooc Phối Phụ Kiện" id="">
                                                    <input type="hidden" name="gia" value="850000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/Quansoocphoiphukien850.jpeg" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Suông Tuysi Nature" data-price="1490000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/QuansuongTuysiNature1490.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Suông Tuysi Nature</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">1.145.000</span> -->
                                            <span class="home-product-item__price-current">1.490.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Suông Tuysi Nature" id="">
                                                    <input type="hidden" name="gia" value="1490000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/QuansuongTuysiNature1490.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Suông Tuysi Nature" data-price="1500000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/QuansuongTuysiNature1500.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Suông Tuysi Nature</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Suông Tuysi Nature" id="">
                                                    <input type="hidden" name="gia" value="1500000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/QuansuongTuysiNature1500.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Shorts Tuysi Gấp Gấu" data-price="548000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/QuanshortTuysigapgau548.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Shorts Tuysi Gấp Gấu</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">995.000</span> -->
                                            <span class="home-product-item__price-current">548.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Shorts Tuysi Gấp Gấu" id="">
                                                    <input type="hidden" name="gia" value="548000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/QuanshortTuysigapgau548.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Quần Jeans Sống Loe Nhẹ" data-price="990000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/Quanjeansongloenhe990.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Quần Jeans Sống Loe Nhẹ</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">995.000</span> -->
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Quần Jeans Sống Loe Nhẹ" id="">
                                                    <input type="hidden" name="gia" value="990000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/Quanjeansongloenhe990.webp" id="">
                                                </form>
                                            </div>
                                        </div>
