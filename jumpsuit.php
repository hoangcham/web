                ...
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-10">
                        ...
                        <div class="home-product">
                            <div class="grid__row">
                                <!-- product item -->
                                <div class="grid__column-2-4" data-name="Jumpsuit Áo Kiểu Phối Dây" data-price="1393000" >
                                    <p class="home-product-item">
                                        <!-- Hình ảnh chính -->
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/JumpsuitAoKieuPhoiDay1393.webp); height: 285px;">
                                        </div>
                                        ...
                                        <h4 class="home-product-item__name">Jumpsuit Áo Kiểu Phối Dây</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">1.393.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tensp" value="Jumpsuit Áo Kiểu Phối Dây" id="">
                                                    <input type="hidden" name="gia" value="1393000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/JumpsuitAoKieuPhoiDay1393.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Set Jumpsuit Cổ K Họa Tiết" data-price="1533000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/SetJumpsuitCoKHoaTiet1533.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Set Jumpsuit Cổ K Họa Tiết</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">1.533.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Set Jumpsuit Cổ K Họa Tiết" id="">
                                                    <input type="hidden" name="gia" value="1533000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/SetJumpsuitCoKHoaTiet1533.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Set Jumpsuit Cổ K Họa Tiết Đen" data-price="1533000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/SetJumpsuitCoKHoaTietDen1533.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Set Jumpsuit Cổ K Họa Tiết Đen</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Set Jumpsuit Cổ K Họa Tiết Đen" id="">
                                                    <input type="hidden" name="gia" value="1533000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/SetJumpsuitCoKHoaTietDen1533.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Set Jumpsuit Tay Baby" data-price="1043000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/quan/SetJumpsuitTayBaby1043.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Set Jumpsuit Tay Baby</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">114.000</span> -->
                                            <span class="home-product-item__price-current">1.043.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Set Jumpsuit Tay Baby" id="">
                                                    <input type="hidden" name="gia" value="1043000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/quan/SetJumpsuitTayBaby1043.webp" id="">
                                                </form>
                                            </div>
                                        </div>
