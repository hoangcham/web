                ...
                <div class="grid__row app__content">
                    ...
                    <div class="grid__column-10">
                        ...
                        <div class="home-product">
                            <div class="grid__row">
                                <!-- product item -->
                                <div class="grid__column-2-4" data-name="Áo Peplum Phối Ren" data-price="749000" >
                                    <p class="home-product-item">
                                        <!-- Hình ảnh chính -->
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/aopeplumphoiren746.webp); height: 285px;">
                                        </div>
                                        ...
                                        <h4 class="home-product-item__name">Áo Peplum Phối Ren</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">749.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tensp" value="Áo Peplum Phối Ren" id="">
                                                    <input type="hidden" name="gia" value="790000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/aopeplumphoiren746.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Áo Sơ Mi Cổ V Chiết" data-price="460000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/aosomicovchiet460.webp); height: 285px; height: 285px;"></div>
                                        <h4 class="home-product-item__name">Áo Sơ Mi Cổ V Chiết</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-current">460.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Áo Sơ Mi Cổ V Chiết" id="">
                                                    <input type="hidden" name="gia" value="460000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/aosomicovchiet460.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Áo Tapta Trễ Vai" data-price="100000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/AoTaptatrevai100.webp); height: 285px; height: 285px;"></div>
                                        <h4 class="home-product-item__name">Áo Tapta Trễ Vai</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Áo Tapta Trễ Vai" id="">
                                                    <input type="hidden" name="gia" value="100000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/AoTaptatrevai100.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Áo Peplum Phối Ren Kiểu 2" data-price="749000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/aopeplumphoiren749.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Áo Peplum Phối Ren Kiểu 2</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Áo Peplum Phối Ren Kiểu 2" id="">
                                                    <input type="hidden" name="gia" value="749000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/aopeplumphoiren749.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Áo Sơ Mi Peplum Cổ Tròn" data-price="553000" >
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/aosomiluaPeplumcotron553.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Áo Sơ Mi Peplum Cổ Tròn</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">1.323.000</span> -->
                                            <span class="home-product-item__price-current">553.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    ...
                                                    <input type="hidden" name="tensp" value="Áo Sơ Mi Peplum Cổ Tròn" id="">
                                                    <input type="hidden" name="gia" value="553000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/aosomiluaPeplumcotron553.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Áo Tapta Trễ vai SK-16M7117" data-price="100000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/AoTaptatrevaiSK-16M7117-100.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Áo Tapta Trễ vai SK-16M7117</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Áo Tapta Trễ vai SK-16M7117" id="">
                                                    <input type="hidden" name="gia" value="100000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/AoTaptatrevaiSK-16M7117-100.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Áo Sơ Mi Peplum Vải" data-price="293000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/AosomiPeplumvaikieu293.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Áo Sơ Mi Peplum Vải</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">1.145.000</span> -->
                                            <span class="home-product-item__price-current">293.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Áo Sơ Mi Peplum Vải" id="">
                                                    <input type="hidden" name="gia" value="293000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/AosomiPeplumvaikieu293.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Lyluta Set Áo Ôm Kiểu" data-price="1290000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/LylutaSet-Aoomkieu-1290.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Lyluta Set Áo Ôm Kiểu</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Lyluta Set Áo Ôm Kiểu" id="">
                                                    <input type="hidden" name="gia" value="1290000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/LylutaSet-Aoomkieu-1290.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Lyluta Set Áo Ôm kiểu SKU-61M8777" data-price="1290000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/LylutaSet-AoomkieuSKU-61M8777-1290.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Lyluta Set Áo Ôm kiểu SKU-61M8777</h4>
                                        <div class="home-product-item__price">
                                        ...
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Lyluta Set Áo Ôm kiểu SKU-61M8777" id="">
                                                    <input type="hidden" name="gia" value="1290000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/LylutaSet-AoomkieuSKU-61M8777-1290.webp" id="">
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="grid__column-2-4" data-name="Cosmo Set Áo Công Sở Peplum" data-price="1590000">
                                    <p class="home-product-item">
                                        <div class="home-product-item__img" style="background-image: url(./assets/img/aopeplum/CosmosSet-Aocongsopeplum1590.webp); height: 285px;"></div>
                                        <h4 class="home-product-item__name">Cosmo Set Áo Công Sở Peplum</h4>
                                        <div class="home-product-item__price">
                                            <!-- <span class="home-product-item__price-old">995.000</span> -->
                                            <span class="home-product-item__price-current">1.590.000</span>
                                        </div>
                                        <div class="home-product-item__action">
                                            <div class="home-product-item__add-to-card">
                                                <form action="chitietsp.php" method="post">
                                                    <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                                                    <input type="hidden" name="tensp" value="Cosmo Set Áo Công Sở Peplum" id="">
                                                    <input type="hidden" name="gia" value="1590000" id="">
                                                    <input type="hidden" name="hinh" value="./assets/img/aopeplum/CosmosSet-Aocongsopeplum1590.webp" id="">
                                                </form>
                                            </div>
                                        </div>
