                    ...
                    <div class="grid__column-2">
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Áo len</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
...
<div class="grid__row">
    <!-- product item -->
    <div class="grid__column-2-4" data-name="Đầm lụa Maxicono" data-price="1190000" >
        <p class="home-product-item">
            <!-- Hình ảnh chính -->
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomituysireplum.webp); height: 285px;">
            </div>
            ...
            <h4 class="home-product-item__name">Áo Sơ Mi Tuysi Replum</h4>
            <div class="home-product-item__price">
                <span class="home-product-item__price-current">1.190.000</span>
            </div>
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        ...
                        <input type="hidden" name="tensp" value="Áo sơ mi Tuysi Replum" id="">
                        <input type="hidden" name="gia" value="1190000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomitest.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo sơ mi Tuysi Drop Waist" data-price="1290000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomituysidropwaist.webp); height: 285px; height: 285px;"></div>
            <h4 class="home-product-item__name">Áo sơ mi Tuysi Drop Waist</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo sơ mi Tuysi Drop Waist" id="">
                        <input type="hidden" name="gia" value="1290000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomituysidropwaist.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Sơ Mi Long Sleeves Tencel" data-price="1090000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomilongsleevestencel.webp); height: 285px; height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Sơ Mi Long Sleeves Tencel</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo Sơ Mi Long Sleeves Tencel" id="">
                        <input type="hidden" name="gia" value="1090000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomilongsleevestencel.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Sơ Mi Tencel Blossom" data-price="1190000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomitencelblossom.webp); height: 285px; height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Sơ Mi Tencel Blossom</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo Sơ Mi Tencel Blossom" id="">
                        <input type="hidden" name="gia" value="1190000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomitencelblossom.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Ladies Mystic Thêu Hoa" data-price="1090000" >
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aoladiesmystictheuhoa.webp); height: 285px; height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Ladies Mystic Thêu Hoa</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        ...
                        <input type="hidden" name="tensp" value="Áo Ladies Mystic Thêu Hoa" id="">
                        <input type="hidden" name="gia" value="1090000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aoladiesmystictheuhoa.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Sơ Mi Lụa Tay Dài Grace" data-price="1350000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomiluataydaigrace.webp); height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Sơ Mi Lụa Tay Dài Grace</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo Sơ Mi Lụa Tay Dài Grace" id="">
                        <input type="hidden" name="gia" value="1350000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomiluataydaigrace.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Sơ Mi Lụa Cổ Đổ Lucile" data-price="950000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomiluacodolucile.webp); height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Sơ Mi Lụa Cổ Đổ Lucile</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo Sơ Mi Lụa Cổ Đổ Lucile" id="">
                        <input type="hidden" name="gia" value="950000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomiluacodolucile.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Sơ Mi Lụa Muse" data-price="990000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomiluamuse.webp); height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Sơ Mi Lụa Muse</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo Sơ Mi Lụa Muse" id="">
                        <input type="hidden" name="gia" value="990000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomiluamuse.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Sơ Mi Tay Liền Phối Voan" data-price="950000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomitaylienphoivoan.webp); height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Sơ Mi Tay Liền Phối Voan</h4>
            <div class="home-product-item__price">
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo Sơ Mi Tay Liền Phối Voan" id="">
                        <input type="hidden" name="gia" value="950000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomitaylienphoivoan.webp" id="">
                    </form>
                </div>
            </div>
    ...
    <div class="grid__column-2-4" data-name="Áo Sơ Mi Tuysi Dáng Ngắn" data-price="890000">
        <p class="home-product-item">
            <div class="home-product-item__img" style="background-image: url(./assets/img/aosomituysidangngan.webp); height: 285px;"></div>
            <h4 class="home-product-item__name">Áo Sơ Mi Tuysi Dáng Ngắn</h4>
            <div class="home-product-item__price">
                <!-- <span class="home-product-item__price-old">995.000</span> -->
            ...
            <div class="home-product-item__action">
                <div class="home-product-item__add-to-card">
                    <form action="chitietsp.php" method="post">
                        <input class="btn btn__add-to-card" type="submit" name="addcart" value="Chi Tiết Sản Phẩm" id="">
                        <input type="hidden" name="tensp" value="Áo Sơ Mi Tuysi Dáng Ngắn" id="">
                        <input type="hidden" name="gia" value="890000" id="">
                        <input type="hidden" name="hinh" value="./assets/img/aosomituysidangngan.webp" id="">
                    </form>
                </div>
            </div>
